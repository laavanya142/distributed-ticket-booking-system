...
class OutboxPublisherIntegrationTest {
    ...
    @Test
    @DisplayName("Successful Outbox Publish: Updates status to PUBLISHED and populates publishedAt")
    ...
    void publishPendingEvents_maxRetriesExceeded_marksStatusFailed() {
        ...
        CompletableFuture<SendResult<String, String>> failedFuture = new CompletableFuture<>();
        failedFuture.completeExceptionally(new RuntimeException("Kafka Persistent Error"));

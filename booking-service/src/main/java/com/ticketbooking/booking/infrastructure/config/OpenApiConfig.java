...
/**
 * OpenAPI 3.0 configuration for the Booking Service API documentation.
 */
@Configuration
    ...
    public OpenAPI bookingServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description(
                                "Saga Orchestrator managing booking aggregate lifecycle, payment coordination, and ticket generation")
                        .version("1.0.0")
